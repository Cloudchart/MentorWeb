...
/***/ function(module, exports, __webpack_require__) {
	...
	Array.prototype.forEach.call(document.querySelectorAll('[data-relay-class]'), function (element) {
	  ...
	  var Route = __webpack_require__(10)("./" + element.dataset.relayRoute);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mutationsAdd_default_themes_for_viewer = __webpack_require__(5);

	var _mutationsAdd_default_themes_for_viewer2 = _interopRequireDefault(_mutationsAdd_default_themes_for_viewer);
	...
	var LandingApp = (function (_React$Component) {
	  ...
	  function LandingApp() {
	    ...
	    this.state = {
	      sync: false,
	      themes: _immutable2['default'].Set()
	    };
	    ...
	    this.render = function () {
	      return React.createElement(
	        ...
	        React.createElement(
	          'ul',
	          null,
	          _this.renderDefaultThemes()
	        ),
	        _this.renderContinueButton()
	      );
	    };

	    this.renderDefaultThemes = function () {
	      return _this.props.viewer.default_themes.map(function (theme) {
	        return React.createElement(
	          'li',
	          { key: theme.id, style: { textTransform: 'capitalize' } },
	          React.createElement(
	            'a',
	            { href: '#', onClick: _this.handleThemeClick.bind(_this, theme.id) },
	            _this.renderThemeStatus(theme.id),
	            theme.name
	          )
	        );
	      });
	    ...
	    this.renderThemeStatus = function (id) {
	      if (_this.state.themes.has(id)) {
	    ...
	    this.renderContinueButton = function (id) {
	      if (_this.state.themes.size < 3) {
	        return null;
	      } else {
	        var spinner = null;
	        if (_this.state.sync) {
	          spinner = React.createElement('i', { className: 'fa fa-spin fa-spinner' });
	        }
	        return React.createElement(
	          'button',
	          { onClick: _this.handleButtonClick, disabled: _this.state.sync },
	          'Continue',
	          spinner
	        );
	      }
	    ...
	    this.handleThemeClick = function (id, event) {
	      event.preventDefault();
	      if (_this.state.sync) {
	        return;
	      }
	      var themes = _this.state.themes;
	      themes = themes.contains(id) ? themes['delete'](id) : themes.add(id);
	      _this.setState({ themes: themes });
	    };
	    ...
	    this.handleButtonClick = function (event) {
	      ...
	      _this.setState({ sync: true });
	      Relay.Store.update(new _mutationsAdd_default_themes_for_viewer2['default']({ themes_ids: _this.state.themes.toArray() }));
	    };
	  }
	  ...
	  fragments: {
	    ...
	    viewer: function viewer() {
	      return (function () {
	        ...
	        return new GraphQL.QueryFragment('Landing', 'User', [new GraphQL.Field('id', null, null, null, null, null, {
	          parentType: 'User',
	          requisite: true
	        }), new GraphQL.Field('name', null, null, null, null, null, {
	          parentType: 'User'
	        }), new GraphQL.Field('default_themes', [new GraphQL.Field('id', null, null, null, null, null, {
	          parentType: 'Theme',
	          requisite: true
	        }), new GraphQL.Field('name', null, null, null, null, null, {
	          parentType: 'Theme'
	...
	var _default = (function (_Relay$Mutation) {
	  ...
	  _createClass(_default, [{
	    ...
	    value: function getMutation() {
	      return (function () {
	        var GraphQL = Relay.QL.__GraphQL;
	        return new GraphQL.Mutation("Add_default_themes_for_viewer", "AddDefaultThemesToViewerPayload", new GraphQL.Callv("addDefaultThemesToViewer", new GraphQL.CallVariable("input")), [new GraphQL.Field("clientMutationId", null, null, null, null, null, {
	          parentType: "AddDefaultThemesToViewerPayload",
	          generated: true,
	          requisite: true
	        })], null, {
	          inputType: "AddDefaultThemesToViewerInput!"
	        });
	      })();
	    }
	  }, {
	    ...
	    value: function getFatQuery() {
	      return (function () {
	        var GraphQL = Relay.QL.__GraphQL;
	        return new GraphQL.QueryFragment("Add_default_themes_for_viewer", "AddDefaultThemesToViewerPayload", [new GraphQL.Field("themes", null, null, null, null, null, {
	          parentType: "AddDefaultThemesToViewerPayload",
	          plural: true
	        })]);
	      })();
